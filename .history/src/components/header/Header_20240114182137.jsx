    ...
    <nav className="bg-[#45013b] p-4" style={{background:''}}>
      <div className="container mx-auto flex items-center sm:justify-between">
        {/* Left logos */}
          ...
          {/* Left logo */}
          <div className="mr-[-350px] sm:mr-4 hidden sm:block">
          <AccountCircleIcon className='text-white  ' style={{fontSize:'43px'}}/>
        ...
        <div className="mr-2">
          ...
          <input
            type="text"
            placeholder="Search"
            className=" p-2 px-12 bg-[#57014a] text-white border-none rounded w-32 md:w-3/5"
          />
        </div>
