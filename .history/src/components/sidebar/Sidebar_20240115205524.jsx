    ...
    <div className="relative">
      ...
      >
        <div className="flex flex-row justify-between items-center">
            <div className="ml-4">
            <h1 className="font-bold text-lg text-gray-100">Clever Programmer</h1>
            <h3 className="text-xs  text-white mt-1 " ><FiberManualRecordIcon className="text-green-600 mr-1" style={{fontSize:'10px'}}/>Muhammad Shamraiz</h3>
            </div>

            <AppRegistrationIcon className="text-white mr-3" style={{fontSize:'35px'}}/>
        </div>
          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Threads</span>
              </a>
            </li>
            <li>
              <li>
