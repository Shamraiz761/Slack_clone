          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-sm">Threads</span>
              </a>
            </li>
            <li>
              <li>
              ...
              <li>
                ...
                >
                  <AddIcon className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover: dark:group-hover:text-white" />
                  <span className="flex-1 ms-3 whitespace-nowrap text-sm">Apps</span>
                </a>
              </li>
              <li>
                <a
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-sm">Sign In</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-sm">Sign Up</span>
              </a>
            </li>
          </ul>
        </div>
