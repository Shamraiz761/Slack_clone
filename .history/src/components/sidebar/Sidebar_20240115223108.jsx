        ...
        <div className="h-full px-3 py-4 overflow-y-auto ">
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                <AddIcon className="flex-shrink-0 w-3 h-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover: dark:group-hover:text-white" />
            ...
            <li>
              ...
              >
                <svg
                  className="flex-shrink-0 w-3 h-3 text-gray-500 transition duration-75 group-hover: dark:text-gray-400 dark:group-hover:text-white"
                  aria-hidden="true"
            ...
            <li>
              ...
              >
                <svg
                  className="flex-shrink-0 w-3 h-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover: dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 18 16"
